...
## 2. Customer Segmentation (Low / Medium / High Spenders)
...
On this page, we extracted a list of the top 10 customers with the highest total spending and identified the store with the greatest overall revenue. Our analysis also shows that the majority of customers from both stores fall within a mid-range spending bracket of $100 to $200 in film rentals.